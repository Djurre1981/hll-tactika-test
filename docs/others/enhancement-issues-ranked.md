...
| -: | --- | --- | --- | --- | --- |
| 1 | Easy | [#6](https://github.com/Djurre1981/hll-tactika-test/issues/6) | Update README for current Strats state | Docs | README + wiki synced Jul 24 2026 (RSVP, event prep, type-ahead). Residual: keep in sync as tools ship. |
...
| 15 | Very hard | [#12](https://github.com/Djurre1981/hll-tactika-test/issues/12) | Match signups / rainchecks / cancellations in Tactika | Integrations | **Partial ✅:** web RSVP (In/Maybe/Out), optional cap, Close RSVP, raincheck after close, Hub + Brief UI. Still open: Discord sync, fill pings, cancellations workflow. |
...
| 17 | Very hard | [#12](https://github.com/Djurre1981/hll-tactika-test/issues/12) | Post-match stats / RCON data analysis | Integrations | Ingest, store, and visualize match telemetry. **Partial:** HeLO history + Circle-side Steam IDs + pilot CRCON game links shipped (`docs/helo-import.md`); full per-player RCON analytics / HLLRecords profiles still open. |
