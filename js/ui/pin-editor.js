...
export function getDraftPin() {
  return document.getElementById("map-draft-pin");
}

export function getDraftArrow() {
...
export function syncViewportModeClasses() {
