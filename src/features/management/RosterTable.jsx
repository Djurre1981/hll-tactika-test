              ...
              >
                <td className="w-[14rem] max-w-[14rem] px-2 py-1.5 align-middle">
                  <div className="flex min-w-0 items-center gap-2">
                    <span
                      className="grid h-7 w-7 shrink-0 place-items-center overflow-hidden rounded-full border border-white/[0.06] bg-white/[0.03] text-[0.58rem] font-medium text-white/40"
                      aria-hidden="true"
                    >
                      {member.avatarUrl ? (
                ...
                <td className="px-2 py-1.5 text-right align-middle">
                  <div className="inline-flex items-center gap-1">
                    ...
                    <button
                      type="button"
                      className="grid h-7 w-7 place-items-center rounded-full border border-white/10 bg-white/[0.05] text-white/60 transition hover:bg-white/[0.1] hover:text-white"
